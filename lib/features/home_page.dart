      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Get.toNamed(Pages.countdown);
              },
              child: Text('Go to Countdown'),
            ),
            TextButton(
              onPressed: () {
                Get.toNamed(Pages.tabPage);
              },
              child: Text('Go to TabPage'),
            ),
            TextButton(
              onPressed: () {
                showBottomSheetDemoDialog(context);
              },
              child: Text('showBottomSheetDialog'),
            ),
            TextButton(
              onPressed: () {
                Get.toNamed(Pages.easyRefreshPage);
              },
              child: Text('EasyRefreshPage'),
            ),
            TextButton(
              onPressed: () {
